...
igRegisterScript("calendarInlineEditorTemplate", (ctx) => {
    return html`
        <igc-calendar value="${ctx.cell.editValue}" @igcChange="${e => ctx.cell.editValue = e.detail}" master_view-scope class="calendar"></igc-calendar>
    `
}, false);
